import cv2
detector_wajah = cv2.CascadeClassifier("../model/haarcascade_frontalface_alt2.xml")
cap = cv2.VideoCapture('../video/video.39') #Video
counter = 0
while True:
    ret, image = cap.read()
    ...
    for (x, y, w, h) in bounding_box:
        ...
        cv2.imwrite("../output_model/videos/{}.jpg".format(counter), gambar_wajah) #Melakukan save foto
